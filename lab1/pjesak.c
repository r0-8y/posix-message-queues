...
int main(void)
{
    ...
    while (1)
    {
        ...
        case 0:
        {
            ...
            printf("Pješak %d došao na poziciju %d.\n", id, position);

            // slanje pozicije ras-u i upr-u
            buf.mtype = MSG_TYPE_CAME;
            buf.mtext[0] = PEDESTRIAN;
            ...
            // krece na kolnik, salje poruku ras-u radi azuriranja prikaza
            printf("%ld: Pješak %d kreće na kolnik.\n", time(NULL), id);
            ...
            // silazi s kolnika i nestaje iz sustava, obavjestava ras
            sleep(3);
            //printf("Pješak %d sišao s kolnika.\n", id);
